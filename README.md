In this challenge, you are required to build a REST API service using Java, Spring and Spring Data to manipulate the Stock data for trades. Each trade is a JSON entry with the following keys:
...
You should complete the given project so that it passes all the test cases. The project should use in-memory DB.
